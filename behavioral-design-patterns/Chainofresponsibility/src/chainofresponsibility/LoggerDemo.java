...
public class LoggerDemo {
    ...
    private static LogProcessor getChainOfLoggers() {
        ...
        LogProcessor fatalLogger =
                new FatalLogProcessor(LogProcessor.FATAL); // 4

        LogProcessor errorLogger =
                new ErrorLogProcessor(LogProcessor.ERROR); // 3

        LogProcessor infoLogger =
                new InfoLogProcessor(LogProcessor.INFO); // 2

        LogProcessor debugLogger =
                new DebugLogProcessor(LogProcessor.DEBUG); // 1
        ...
        // fatalLogger.nextLoggerProcessor is null
